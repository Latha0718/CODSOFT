...
title_font = ("Helvetica", 20, "underline")
...
button_generate = Button(root, text="Generate Password", command=new_rand, bg="dark blue", fg="white")
button_generate.pack(pady=10)

frame_buttons = Frame(root)
frame_buttons.pack(pady=10)

button_accept = Button(frame_buttons, text="Accept", fg="dark blue", bg="white", relief=RAISED, bd=3)
button_accept.pack(side=LEFT, padx=10)

button_reset = Button(frame_buttons, text="Reset", command=reset_password, fg="dark blue", bg="white", relief=RAISED, bd=3)
